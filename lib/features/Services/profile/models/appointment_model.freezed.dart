...
mixin _$AppointmentModel {
 ...
 int get id;@JsonKey(name: 'owner_id') int get ownerId;@JsonKey(name: 'owner_type') String get ownerType; String get date;@JsonKey(name: 'start_time') String get startTime;@JsonKey(name: 'end_time') String get endTime; int get price; String get reason; String get status; String? get result;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,ownerId,ownerType,date,startTime,endTime,price,reason,status,result);

@override
String toString() {
  return 'AppointmentModel(id: $id, ownerId: $ownerId, ownerType: $ownerType, date: $date, startTime: $startTime, endTime: $endTime, price: $price, reason: $reason, status: $status, result: $result)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'owner_id') int ownerId,@JsonKey(name: 'owner_type') String ownerType, String date,@JsonKey(name: 'start_time') String startTime,@JsonKey(name: 'end_time') String endTime, int price, String reason, String status, String? result
});
...
/// Create a copy of AppointmentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? ownerId = null,Object? ownerType = null,Object? date = null,Object? startTime = null,Object? endTime = null,Object? price = null,Object? reason = null,Object? status = null,Object? result = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'owner_id')  int ownerId, @JsonKey(name: 'owner_type')  String ownerType,  String date, @JsonKey(name: 'start_time')  String startTime, @JsonKey(name: 'end_time')  String endTime,  int price,  String reason,  String status,  String? result)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppointmentModel() when $default != null:
return $default(_that.id,_that.ownerId,_that.ownerType,_that.date,_that.startTime,_that.endTime,_that.price,_that.reason,_that.status,_that.result);case _:
  return orElse();
...
class _AppointmentModel implements AppointmentModel {
  const _AppointmentModel({required this.id, @JsonKey(name: 'owner_id') required this.ownerId, @JsonKey(name: 'owner_type') required this.ownerType, required this.date, @JsonKey(name: 'start_time') required this.startTime, @JsonKey(name: 'end_time') required this.endTime, required this.price, required this.reason, required this.status, required this.result});
...
/// Create a copy of AppointmentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? ownerId = null,Object? ownerType = null,Object? date = null,Object? startTime = null,Object? endTime = null,Object? price = null,Object? reason = null,Object? status = null,Object? result = freezed,}) {
