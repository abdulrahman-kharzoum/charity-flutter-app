...
mixin _$ResendOtpState {
 ...
 SubmissionStatus get status; ResendOtpResponseModel? get data; Failure? get failure;
/// Create a copy of ResendOtpState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ResendOtpStateCopyWith<ResendOtpState> get copyWith => _$ResendOtpStateCopyWithImpl<ResendOtpState>(this as ResendOtpState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResendOtpState&&(identical(other.status, status) || other.status == status)&&(identical(other.data, data) || other.data == data)&&(identical(other.failure, failure) || other.failure == failure));
}
...
@override
String toString() {
  return 'ResendOtpState(status: $status, data: $data, failure: $failure)';
}
...
/// @nodoc
abstract mixin class $ResendOtpStateCopyWith<$Res>  {
  factory $ResendOtpStateCopyWith(ResendOtpState value, $Res Function(ResendOtpState) _then) = _$ResendOtpStateCopyWithImpl;
@useResult
$Res call({
 SubmissionStatus status, ResendOtpResponseModel? data, Failure? failure
});


$ResendOtpResponseModelCopyWith<$Res>? get data;

}
/// @nodoc
class _$ResendOtpStateCopyWithImpl<$Res>
    implements $ResendOtpStateCopyWith<$Res> {
  _$ResendOtpStateCopyWithImpl(this._self, this._then);

  final ResendOtpState _self;
...
as ResendOtpResponseModel?,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
as Failure?,
  ));
}
/// Create a copy of ResendOtpState
...
$ResendOtpResponseModelCopyWith<$Res>? get data {
  ...
  return $ResendOtpResponseModelCopyWith<$Res>(_self.data!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SubmissionStatus status,  ResendOtpResponseModel? data,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SubmissionStatus status,  ResendOtpResponseModel? data,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState():
return $default(_that.status,_that.data,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SubmissionStatus status,  ResendOtpResponseModel? data,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
return $default(_that.status,_that.data,_that.failure);case _:
  return null;
...
class _CreateTeacherState implements ResendOtpState {
...
@override final  ResendOtpResponseModel? data;
...
/// @nodoc
abstract mixin class _$CreateTeacherStateCopyWith<$Res> implements $ResendOtpStateCopyWith<$Res> {
...
@override $ResendOtpResponseModelCopyWith<$Res>? get data;
