...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifyOtpState&&(identical(other.status, status) || other.status == status)&&(identical(other.data, data) || other.data == data)&&(identical(other.failure, failure) || other.failure == failure));
}
...
@useResult
$Res call({
 SubmissionStatus status, VerifyOtpResponseModel? data, Failure? failure
});


$VerifyOtpResponseModelCopyWith<$Res>? get data;
...
as VerifyOtpResponseModel?,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
as Failure?,
  ));
}
/// Create a copy of VerifyOtpState
...
$VerifyOtpResponseModelCopyWith<$Res>? get data {
  ...
  return $VerifyOtpResponseModelCopyWith<$Res>(_self.data!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SubmissionStatus status,  VerifyOtpResponseModel? data,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SubmissionStatus status,  VerifyOtpResponseModel? data,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState():
return $default(_that.status,_that.data,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SubmissionStatus status,  VerifyOtpResponseModel? data,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
return $default(_that.status,_that.data,_that.failure);case _:
  return null;
...
@override final  VerifyOtpResponseModel? data;
...
/// @nodoc
abstract mixin class _$CreateTeacherStateCopyWith<$Res> implements $VerifyOtpStateCopyWith<$Res> {
...
@override $VerifyOtpResponseModelCopyWith<$Res>? get data;
